...
def process_silver_order_payments(spark: SparkSession, bronze_table_name: str, silver_table_name: str, checkpoint_path: str):
    ...
    def upsert_to_silver(micro_batch_df, batch_id):
        ...
        (silver_delta_table.alias("s") 
            .merge(
                ...
                "s.order_id = b.order_id AND s.payment_sequential = b.payment_sequential"
            )
...
if __name__ == "__main__":
    ...
    process_silver_order_payments(spark, bronze_table_full_name, silver_table_full_name, checkpoint_path)