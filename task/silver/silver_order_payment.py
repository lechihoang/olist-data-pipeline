...
def process_silver_order_payment(spark: SparkSession, bronze_table_name: str, silver_table_name: str, checkpoint_path: str):
...
if __name__ == "__main__":
    ...
    process_silver_order_payment(spark, bronze_table_full_name, silver_table_full_name, checkpoint_path)
